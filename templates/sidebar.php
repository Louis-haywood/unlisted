...
function nav_active(string $uri, string|array $match, array $exclude = []): string {
    foreach ($exclude as $ex) {
        if ($uri === $ex || str_starts_with($uri, $ex . '/')) return '';
    }
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="/loans" class="nav-item<?= nav_active($uri, 'loans', ['loans/checkout']) ?>">
